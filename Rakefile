...
require 'hoe'
include FileUtils
require File.join(File.dirname(__FILE__), 'lib', 'GRuby', 'version')

AUTHOR = "fazibear"  # can also be an array of Authors
EMAIL = "fazibear@gmail.com"
DESCRIPTION = "Gadu-Gadu protocol implementation for Ruby language"
GEM_NAME = "GRuby" # what ppl will type to install your gem
RUBYFORGE_PROJECT = "gruby" # The unix name for your project
